...
### 저는 _____ 입니다.
- 5년 차 백엔드 엔지니어 (Kotlin / Spring Boot) 🚀
- 레거시 모놀리식 시스템을 현대화된 아키텍처로 리팩토링하는 개발자 🛠
- 대용량 미디어 및 AdTech 플랫폼 경험을 가진 개발자 ⚡
- 커뮤니케이션과 협업에 진심인 개발자 🤝
...
- 대용량 CMS 데이터 호환성 유지 및 안정적인 단계별 전환(Migration) 수행
### Tech Stack
...
### What did I do?
- 기술스택 검토 및 글로벌 확장형 아키텍처 설계
- Kotlin / Spring Boot 기반 고성능 Ad Decision API 구축
### Tech Stack
- Kotlin, Spring Boot, RDB, Redis

<br>
<br>

## [신규기능 / 유지보수]<br>광고 서버 모니터링 배치 & 대용량 API 개발
2021.12 ~ 2024.01
### Description
- 광고 중계 서버 에러 로깅/집계 모니터링 시스템 구축 및 FAST 스케줄/EPG/피드 전송 API 개발
### What did I do?
- 로그 포맷 및 배치 처리 알람 시스템 설계 (AWS EC2, Email, Slack 연동)
- LG Channels EPG 전송 및 in-house CMS 스케줄 API 성능 최적화 (응답 속도 개선)
- 릴레이 서버 구축 및 릴레이 API 개발
### Tech Stack
...
## [신규기능]<br>Cloud Video QC & HEVC Codec 자동화
2022.01 ~ 2022.04
### Description
- 클라우드 기반 비디오 QC 자동화 프로세스 구축 및 HEVC/H.265 고화질 저용량 인코딩 개발
### What did I do?
- AWS EC2 기반 FFmpeg 라이브러리 및 Netflix VMAF 오픈소스 연동 비디오 QC 도구 개발
- 텔레그램 장애 알림 연동 및 QC 작업 큐 상태 기반 가용 인스턴스 자동 관리
- Multi-Codec Master Playlist(Manifest) 인코딩 개발
### Tech Stack
...
2023.03 ~ Current
### Description
- 커리어를 관리하듯 취미를 관리하자! (취미 활동 아카이빙 플랫폼)
### What did I do?
- 서버 아키텍처 및 DB 테이블 설계
- AWS (Ubuntu) 서버 환경 구성 및 CI/CD 구축
...
# [특허정보](https://github.com/DongWon-Sehr/resume/tree/main/lang/ko#목차)
